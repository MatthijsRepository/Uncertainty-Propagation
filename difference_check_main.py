...
from difference_check_uncertainty_engine import UncertaintyEngine
...
if __name__=="__main__":
    ...
    print(f"{variables['G'].uncertainty.total_uncertainty[600]} , {variables['G'].uncertainty.total_uncertainty[601]}")
    print(f"Sum: {variables['G'].uncertainty.total_uncertainty[600] + variables['G'].uncertainty.total_uncertainty[601]}")
    rootsqsum_300 = np.sqrt(variables['G'].uncertainty.total_uncertainty[600]**2 + variables['G'].uncertainty.total_uncertainty[601]**2)
    
    hard_calc_sq = variables['G'].uncertainty.total_uncertainty[600]**2 + variables['G'].uncertainty.total_uncertainty[601]**2 + \
        variables['G'].uncertainty.total_uncertainty[600]* variables['G'].uncertainty.total_uncertainty[601] * 2
        
    hard_calc = np.sqrt(hard_calc_sq)
    
    
    print(f"Hard aggregation: {hard_calc}")
    print(f"New method")
    print(hourly_aggregation[300])
