...
class JobHandler:
    ...
    def _prepareEngines(self):
        ...
        Although inherent dependency between engines can be avoided, the job handler makes engines aware about each other to simplify direct usage of the engines in the ``main`` script.
